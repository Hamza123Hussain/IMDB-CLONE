...
export default function Movie({ params }) {
  ...
  return (
    <>
      <div className="flex flex-col justify-center h-screen mt-20  items-center my-20 sm:mt-0 px-3">
        <div className="dark:bg-black dark:text-white relative flex flex-col md:flex-row space-x-2 md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-3xl mx-auto border border-white bg-white">
